...
const messages = {
    'en': {
        ...
        Project3Desc: 'Development of a menu for a example restaurant with vanila js',
    ...
    'es': {
        ...
        Project3Desc: 'Desarrollo de una pagina web de un menu con puro javascript',
    ...
    'cat': {
        ...
        Project3Desc: "Desenvolupament del menu d'un restaurant amb javascript.",
